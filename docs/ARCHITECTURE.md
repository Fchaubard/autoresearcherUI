...
[Back to the README](../README.md). This guide keeps the complete operating flow, agent details, additional screens, email setup, architecture, and development commands.
...
earth. Set a strong passcode to lock down the node; it is the public dashboard’s only access barrier. 
...
The tracking, monitoring, and paper workspace run on your node; Claude Code and any optional council API usage are separate costs.
...
every chat message).
![Scoping gate](screenshots/scoping.png)
...
![Onboarding / Settings](screenshots/onboarding-settings.png)
...
failed.
![Lessons learned](screenshots/lessons-learned.png)
...
metric view.
![Tmux Sessions](screenshots/tmux-sessions.png)
...
draft in real time.
![Write the paper](screenshots/write-the-paper.png)
...
![Send the paper / share link](screenshots/send-the-paper.png)
...
project-best run).
![System Stats](screenshots/system-stats.png)
...
![Research-mode email](screenshots/email-researcher.png)
...
view.
![Paper-mode email](screenshots/email-author.png)


**Mobile view** - load it from anywhere and talk to your Claude Code instance right from your phone.

<p>
  <img src="screenshots/iphone1.png" width="45%" alt="autoresearcherUI on mobile - dashboard" />
  &nbsp;
  <img src="screenshots/iphone2.png" width="45%" alt="autoresearcherUI on mobile - agent" />
</p>
...
<p>
  <img src="screenshots/email1.png" width="45%" alt="Email digest" />
  &nbsp;
  <img src="screenshots/email2.png" width="45%" alt="Email digest" />
</p>
